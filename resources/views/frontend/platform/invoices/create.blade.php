...
@section('content')
    <main class="clients invoices create-invoice">
        ...
        <form action="{{ route('invoices.store') }}" method="POST" class="prevent-enter">
            @csrf
            <div class="dashboard-header">
                ...
                <div class="clients-btns">
                    ...
                    <button class="exp-clients-btn" formaction="{{ route('invoices.draft') }}">SAVE</button>
            ...
            <div class="send-invoice open-send-invoice-popup">
                <div class="send-invoice-content">
                    ...
                    <div class="send-invoice-btns">
                        ...
                        <button class="send-invoice-send-btn" data-toggle="modal">Send</button>
                    </div>
                </div>
            </div>
