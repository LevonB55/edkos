...
<main class="clients invoices">
    <div class="dashboard-header">
        ...
        <div class="clients-btns">
            <a class="new-clients-btn" href="ds-proposals-template.html">NEW Proposal</a>
        </div>
                ...
                <div class="invoice-item">
                    <a class="image-upload" href="ds-estimates-template.html">
                        <label for="file-input" class="d-flex justify-content-center">
                            ...
                            <h4 class="add-new-client">Create New Proposal</h4>
                        </label>
                    </a>
                </div>
                    ...
                    <th>
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdown-clients">
                                <button class="dropdown-item" type="button">Archived Proposals</button>
                                <div class="inside-line"></div>
                                <button class="dropdown-item" type="button">Deleted Proposals</button>
                            </div>
                        </div>
                    </th>
