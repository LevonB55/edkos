...
@section('title', 'Proposals Template')
...
<main class="clients invoices">
    <div class="dashboard-header">
        <h1 class="dashboard-clients-title invoice-title-name">New Proposal</h1>
    ...
    <div class="send-invoice open-send-invoice-popup">
        <div class="send-invoice-content">
            ...
            <div class="send-invoice-btns">
                ...
                <a class="send-invoice-send-btn"  data-toggle="modal" data-target="#signUpProposal" id="send-signature-confirm">Send</a>
            </div>
        </div>
    </div>
...
<div class="modal fade z-index-modal" id="signUpProposal" tabindex="-1" role="dialog" aria-labelledby="signUpProposal" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="d-flex clients-header-title justify-content-between align-items-center">
                    <div class="add-new-client-title">Sign To Accept The Proposal</div>
                    <div class="add-new-close" aria-hidden="true" data-dismiss="modal" aria-label="Close">&times;</div>
                </div>
                <div class="confirm-signature">
                    <input class="signature-input" placeholder="Enter Your Name">
                    <div class="company-logo-file">
                        <a class="image-upload">
                            <label for="company-logo" class="d-flex justify-content-center">
                                <h4 class="company-logo">Drag Your Signature Or</h4>
                                <h4 class="select-a-file">Select A File</h4>
                            </label>
                            <input id="company-logo-9" type="file">
                        </a>
                    </div>
                    <canvas id="sig-canvas" width="600" height="160"></canvas>
                    <div class="signature-content">
                        <button class="btn-submit-signature" id="sig-submitBtn">Submit Signature</button>
                        <button class="btn-clear-signature" id="sig-clearBtn">Clear Signature</button>
                    </div>
                    <div class="signed-on">
                        <p class="text-1">Signed On</p>
                        <p class="text-2">05/11/2019</p>
                    </div>
                    <div class="signature-block">
                        <label class="container">
                            <input type="checkbox">
                            <span class="checkmark"></span>
                            <p class="signature-text-popup">
                                I agree that this is a legally binding representation of my
                                signature, just the same as pen and paper.
                            </p>
                        </label>
                    </div>
                    <a class="btn-confirm">confirm signature</a>
                    <p class="term-and-conditions">By confirming, you agree to the  <span>Term and Conditions</span></p>
                </div>
            </div>
        </div>
    </div>
